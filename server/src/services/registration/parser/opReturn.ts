/**
 * OP_RETURN parser utilities for registration verification.
 *
...
/** Validate that a hex string has even length and only hex chars. */
function assertValidHexString(hex: string): void {
...
/** Convert a hex string of ASCII bytes to a JS string. */
function asciiHexToString(dataHex: string): string {
